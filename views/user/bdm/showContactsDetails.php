                ...
                if(response.length == 0 && isUpdateOffsetPristine == true)
                    ...
                    for(var i=0; i<response.length; i++) 
                    {
                       ...
                       // clientListBuilder += "<td align='center'><button type='button' class='btn btn-success btn-sm action-btn' title='Company List''  onclick='showClientCompany(" + response[i].client_company_id + ")' ><span class='glyphicon glyphicon-home'></span></button></td>";
                        ...
                        {
                            clientListBuilder += "<td><a href='email_send.php?id=" + response[i].id +"&companyId="+ response[i].company+"'><p style='color:green;'> Send Proposal </p></a></td>";                          
                        }
                        else
                        {
                        ...
                        clientListBuilder += "</tr>";
                        //$("#company").html(response[i].client_company_name);
                    }
        ...
        <div class="container-fluid">
            ...
            <?php if ($_SESSION['role'] == "BDM") : ?>
             ...
             <?php
                 ...
                 // echo $bde_emp_id;
                  $companyidsql="select client_company_name from client_companies where client_company_id='$companyid'";
                  $companyidresult=mysqli_query($conn,$companyidsql);
                  $companyidrow=mysqli_fetch_object($companyidresult);
                  $companyidname=$companyidrow->client_company_name;
             ?>
             ...
             <h3 class="text-center">  Client Contact List of "<b><?php echo $companyidname;?></b>" Company  </h3>
      ...
      <div id="myModalClient" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
        ...
        <div class="modal-content">
             <div class="modal-header" style="background-color: #55bcc9;">
                 <button type="button" class="close" data-dismiss="modal">&times;</button>
                 <h3 class="modal-title text-center" style="color:#fff;">Client Details</h3>
             </div>
             ...
             <div id="showCompany">
              ...
              <br> 
             <div class="modal-footer" id="footer" style="background-color: #93b0ab;margin:0px -15px -15px -15px;text-align:center;">
                 <button type="button" class="btn btn-danger"  data-dismiss="modal">Close</button>
             </div>
        </div>
        </div>
