                            ...
                            <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false">
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-header" style="background-color:#55bcc9;">      
                                        ...
                                        <div class="modal-body" style="background-color: #e7efdd;">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-8" >
                                                            <div class="form-group" id="emailBtn">
                                                                <input id="clientEmail" name="clientEmail" type="text" class="form-control email-append-input" placeholder="Please Enter Your Email id" form="form1" onfocusout="validateClientEmail()"> 
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                         ...
                                                         <div class="col-sm-8" >
                                                            <div class="form-group" id="emailBtn">
                                                                <input id="clientEmail2" name="clientEmail2" type="text" class="form-control email-append-input" placeholder="Please Enter Your Email-id If Available" form="form1" onfocusout="validateClientEmail2()"> 
                                                                <i style="color:red" id="clientEmailError"></i>
                                                         </div>    
                                                    </div>
                                                </div><!--row end-->
                                                 <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                                         ...
                                                         <div class="col-sm-8" >
                                                            <div class="form-group" id="emailBtn">
                                                                <input id="clientEmail3" name="clientEmail3" type="text" class="form-control email-append-input" placeholder="Please Enter Your Email-id If Available" form="form1" onfocusout="validateClientEmail3()"> 
                                                                <i style="color:red" id="clientEmailError"></i>
                                                         </div>    
                                                    </div>
                                                </div><!--row end-->
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label>Phone No1.: <span class="glyphicon glyphicon-asterisk imp"></span> </label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input id="clientPhone1" name="clientPhone1" type="text" class="form-control" placeholder="Please Enter Your Phone no.1 "    form="form1" onfocusout="validateClientPhone1()">
                                                        <i style="color:red" id="clientPhone1Error"></i>
                                                    </div>
                                                </div><!-- row end -->
                                            </div>
                                            <div class="form-group">
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <label>Phone No2.: <span class="glyphicon glyphicon-asterisk imp"></span> </label>
                                                    </div>
                                                    <div class="col-sm-8">
                                                        <input id="clientPhone2" name="clientPhone2" type="text" class="form-control" placeholder="Please Enter Your Phone no.2"    form="form1" onfocusout="validateClientPhone2()">
                                                        <i style="color:red" id="clientPhone2Error"></i>
                                                    </div>
                                                </div><!-- row end -->
                                            </div>
                                            <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row text-center">
                                                <input type="button" value="SaveContact"  id="saveClient" class="btn btn-success"  onClick="saveClient()" style="border:0px;">
                                                <input  type="button" value="Reset"  class="btn btn-danger" onclick="resetInputField()" style="border:0px;">  
                                            </div><!-- row end -->
                                        </div>
                                    </div> <!-- input field end here -->
                                </div><!--Model -content end here-->
                            </div><!--Model End Here-->
