                ...
                ?>
                    <div class="row">
                        ...
                        <div class="col-sm-9" style="margin-top: 45px;">
                            <!-- Panel start-->
                            <div class="panel panel-primary bdm-panel">
                                <div class="panel-heading">
                                    <div class="panel-title text-center"> <p style="color:#FFF;text-shadow:none;margin-top:10px; font-size: 30px;"> Send Email </p> </div>
                                   
                                </div>
                                <div class="text-center" ><span class="glyphicon glyphicon-asterisk" style="color:red; font-size:10px;   vertical-align: super;"></span><i style="color:green;"> Subject and Message are mandatory fields and maximun 3 files can attach in this form. </i></div>
                                ...
                                <div class="row">
                                    <div class="col-sm-3"></div>
                                     <div class="col-sm-2"><button type="button" id="add-another-file-btn" class="btn btn-primary btn-sm" title="Add File" onclick="addAnotherFile()">Add Another File</button></div>
                                      <div class="col-sm-2"> <button type="button" id="remove-file-btn" title="Remove selected file" class="btn btn-warning btn-sm" onclick="removeFile()">Remove File</button></div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-sm-12 text-center">
                                                <button type="button"  class="btn btn-primary" title="Send Mail" onclick="validate()"> Send </button>
                                                <?php
                                                   if(isset($_GET['empid'])) {
                                                     ?>
                            ...
                            if(ext =="pdf" || ext=="doc" || ext=="docx" || ext=="gif" || ext=="jpeg" || ext=="jpg" || ext=="png" || ext=="zip" || ext=="txt")
                            {
                                ...
                                if(attach_size_kb == 0){
                                     attachErrorFlag = true;
                                        ...
                                        attachErrorMsg = "Please upload a file greater than 0 kb";
                                        
                                        document.getElementById("add-another-file-btn").disabled = true;
                                }
                                else if(attach_size_kb > 1000) {
