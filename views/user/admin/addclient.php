                        ...
                        <div class="col-sm-offset-1 col-sm-10">
                            <form id="addClientForm" class="form-horizontal" enctype="multipart/form-data" action="<?php echo BASEURL; ?>actions/admin/performaddclient.php" method="post">
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Company Name<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Company Website<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Company Phone<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Company E-Mail<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Company LinkedIn<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Company Address<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Assign To BDM<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                ...
                                <div class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Assign To BDE<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
    ...
    <div id="contactModal" class="modal fade" role="dialog" data-backdrop="static" data-keyboard="false">
        <div class="modal-dialog modal-mod">
            <div class="modal-content">
                <div class="modal-header modal-header-mod" style="background-color:#55bcc9 ; color: white;">
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div id="contact-email-div" class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">E-Mail 1<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="Enter E-Mail 1 Address" class="form-control" onfocusout="validateContactEmail()">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-6">
                                <div id="contact-email2-div" class="form-group form-group-mod">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" placeholder="Enter E-Mail 2 Address" class="form-control" onfocusout="validateContactEmail2()">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div id="contact-email3-div" class="form-group form-group-mod">
                                    ...
                                    <div class="col-sm-9">
                                    <input type="text" placeholder="Enter E-Mail 3 Address" class="form-control" onfocusout="validateContactEmail3()">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div id="contact-phone1-div" class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Phone No.1<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="Please Enter Phone Number One" class="form-control" onfocusout="validateContactPhone1()">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-sm-6">
                                <div id="contact-phone2-div" class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Phone No.2<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                                        <input type="text" placeholder="Enter Phone Number Two" class="form-control" onfocusout="validateContactPhone2()">
                                        <p></p>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                <div id="contact-address-div" class="form-group form-group-mod">
                                    <label class="control-label col-sm-3">Address<span class="glyphicon glyphicon-asterisk imp"></span></label>
                                    <div class="col-sm-9">
                ...
                <div class="modal-footer modal-footer-mod" style="background-color:#bfd8d2;">
    ...
    <script>
        ...
        */
        function addContactFieldsToMainForm() {
            if(validateContactFields()) {
                ...
                $('#addClientForm').append("<input type='hidden' id='contact_form_" + contactId + "_email2' name='contact_form_" + contactId + "_email2' value='" + $("#contact-email2-div input").val() + "'>");
                $('#addClientForm').append("<input type='hidden' id='contact_form_" + contactId + "_email3' name='contact_form_" + contactId + "_email3' value='" + $("#contact-email3-div input").val() + "'>");
                ...
                $('#addClientForm').append("<input type='hidden' id='contact_form_" + contactId + "_phone1' name='contact_form_" + contactId + "_phone1' value='" + $("#contact-phone1-div input").val() + "'>");
                $('#addClientForm').append("<input type='hidden' id='contact_form_" + contactId + "_phone2' name='contact_form_" + contactId + "_phone2' value='" + $("#contact-phone2-div input").val() + "'>");
        ...
        */
        ...
        function repopulateModal(id) {
            ...
            $("#contact-email2-div input").val($("#contact_form_" + id + "_email2").val());
            $("#contact-email3-div input").val($("#contact_form_" + id + "_email3").val());
            ...
            $("#contact-phone1-div input").val($("#contact_form_" + id + "_phone1").val());
            $("#contact-phone2-div input").val($("#contact_form_" + id + "_phone2").val());
        ...
        function updateContact(id) {
            if(validateContactFields()) {
                ...
                $("#contact_form_" + id + "_email2").val($("#contact-email2-div input").val());
                $("#contact_form_" + id + "_email3").val($("#contact-email3-div input").val());
                ...
                $("#contact_form_" + id + "_phone1").val($("#contact-phone1-div input").val());
                $("#contact_form_" + id + "_phone2").val($("#contact-phone2-div input").val());
        ...
        */
        function deleteContact(id) {
            ...
            if(result) {
                ...
                $("#contact_form_" + id + "_email2").remove();
                $("#contact_form_" + id + "_email3").remove();
                $("#contact_form_" + id + "_category").remove();
                $("#contact_form_" + id + "_designation").remove();
                $("#contact_form_" + id + "_phone1").remove();
                $("#contact_form_" + id + "_phone2").remove();
        ...
        function shiftContactFieldsInMainForm(id) {
            ...
            for(var j = id; j <= originalContactId; j++) {
                ...
                email2 = $("#contact_form_" + (j+1) + "_email2").val();
                $("#contact_form_" + (j+1) + "_email2").attr('id', 'contact_form_' + j + '_email2');
                $("#contact_form_" + j + "_email2").attr('name', 'contact_form_' + j + '_email2');
                $("#contact_form_" + j + "_email2").val(email2);
                email3 = $("#contact_form_" + (j+1) + "_email3").val();
                $("#contact_form_" + (j+1) + "_email3").attr('id', 'contact_form_' + j + '_email3');
                $("#contact_form_" + j + "_email3").attr('name', 'contact_form_' + j + '_email3');
                $("#contact_form_" + j + "_email3").val(email3);
                ...
                phone1 = $("#contact_form_" + (j+1) + "phone1").val();
                $("#contact_form_" + (j+1) + "_phone1").attr('id', 'contact_form_' + j + '_phone1');
                $("#contact_form_" + j + "_phone1").attr('name', 'contact_form_' + j + '_phone1');
                $("#contact_form_" + j + "_phone1").val(phone1);
                phone2 = $("#contact_form_" + (j+1) + "_phone2").val();
                $("#contact_form_" + (j+1) + "_phone2").attr('id', 'contact_form_' + j + '_phone2');
                $("#contact_form_" + j + "_phone2").attr('name', 'contact_form_' + j + '_phone2');
                $("#contact_form_" + j + "_phone2").val(phone2);
