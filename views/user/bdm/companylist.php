                    ...
                    for(var i=0; i<response.length; i++) { 
                        var bdeListBuilder = "";
                                   ...
                                   // bdeListBuilder += "<td>" + response[i].linkedin + "</td>";
                                    ...
                                    bdeListBuilder += "<td><button class='btn btn-primary action-btn' title='Client Contacts' onclick='showContacts(" + response[i].id + ")'><span class='glyphicon glyphicon-pawn'></span></button></td>'";
                                    bdeListBuilder += "</tr>";
