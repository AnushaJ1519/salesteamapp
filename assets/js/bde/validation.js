...
function validateClientEmails1()
{
    ...
    $("#clientEmail").css({"border":"2px solid green"});
        if(clientEmail=="" || clientEmail == null || clientEmail == undefined)
			...
			clientEmailErrorMsg="Email Required !"; 
            }
...
function validateClientEmails2()
{
    ...
    $("#clientEmail2").css({"border":"2px solid green"});
        if(clientEmail2=="")
        {
            ...
            $("#clientEmail2").css({"border-color":"red"});
        }
        else if(!EmailRegEx2.test(clientEmail2))
        {
         $("#clientEmail2").css({"border":"2px solid red"}) ; 
         clientEmailErrorMsg2="Invalid Email format"; 		 
        }
		 $("#clientEmailError2").text(clientEmailErrorMsg2);
}
...
function validateClientEmails3()
{
    ...
    if(clientEmail3=="")
    {
        ...
        $("#clientEmail3").css({"border-color":"red"});
    }
    else if(!EmailRegEx3.test(clientEmail3))
    {
         $("#clientEmail3").css({"border":"2px solid red"}) ;
        clientEmailErrorMsg3="Invalid Email format";      
    }
        $("#clientEmailError3").text(clientEmailErrorMsg3);
}
...
function validateClientEmail()
{
    ...
    $("#clientEmail").css({"border":"2px solid green"});
        if(clientEmail=="" || clientEmail == null || clientEmail == undefined){
            clientEmailErrorFlag=true;
            $("#clientEmail").css({"border":"2px solid red"}) ;
            clientEmailErrorMsg="Please Enter Your Email-Id One";
        }else if(clientEmail.match(whiteSpaceRegEx)) {
        clientEmailErrorFlag = true;
        clientEmailErrorMsg = "Whitespace Is Not Allowed !";
        $("#clientEmail").css({"border-color":"red"});
...
function validateClientEmail2()
{
    ...
    {
        clientEmailErrorFlag2=false;
        $("#clientEmail2").css({"border":""}) ;
        //clientEmailErrorMsg2="Please Enter Your Two If Available Email-Id ";
    }else if(clientEmail2.match(whiteSpaceRegEx)) {
        clientEmailErrorFlag2 = true;
        clientEmailErrorMsg2 = "Whitespace Is Not Allowed !";
        $("#clientEmail2").css({"border-color":"red"});
...
function validateClientEmail3()
{
    ...
    if(clientEmail3=="")
    {
        clientEmailErrorFlag3=false;
        $("#clientEmail3").css({"border":""});
        //clientEmailErrorMsg3="Please Enter Your Three If Available Email-Id";
    }else if(clientEmail3.match(whiteSpaceRegEx)) {
        clientEmailErrorFlag3 = true;
        clientEmailErrorMsg3 = "Whitespace Is Not Allowed !";
        $("#clientEmail3").css({"border-color":"red"});
...
{
    var clientPhone1 = $("#clientPhone1").val().trim();
    clientPhone1ErrorFlag=false;
    clientPhone1ErrorMsg="";
    $("#clientPhone1").css({"border":"2px solid green"});
    if(clientPhone1==""||clientPhone1.length<10||clientPhone1.length>10||isNaN(clientPhone1))
        {
            clientPhone1ErrorFlag=true;
            $("#clientPhone1").css({"border":"2px solid red"}) ;
            clientPhone1ErrorMsg="Please Enter Your Phone Number One";
        }
        $("#clientPhone1Error").text(clientPhone1ErrorMsg);
}

function validateClientPhone2()
{
    var clientPhone2 = $("#clientPhone2").val().trim();
    clientPhone2ErrorFlag=false;
    clientPhone2ErrorMsg="";
    $("#clientPhone2").css({"border":"2px solid green"});
    if(clientPhone2==""||clientPhone2.length<10||clientPhone2.length>10||isNaN(clientPhone2))
        {
            clientPhone2ErrorFlag=true;
            $("#clientPhone2").css({"border":"2px solid red"}) ;
            clientPhone2ErrorMsg="Please Enter Your Phone Number Two";
        }
        $("#clientPhone2Error").text(clientPhone2ErrorMsg);
...
function validateUpdateClient() {
    ...
    validateClientPhone1();
    validateClientPhone2();
    ...
    validateClientState();
    validateClientCity();
            if(clientFirstNameErrorFlag == false && clientLastNameErrorFlag == false && clientEmailErrorFlag == false && clientEmailErrorFlag2 == false&& clientEmailErrorFlag3 == false&& 
                clientPhone1ErrorFlag == false && clientPhone2ErrorFlag == false && clientCategoryErrorFlag == false && clientDesignationErrorFlag == false && 
...
if(clientFirstNameErrorFlag == false && clientLastNameErrorFlag == false && clientEmailErrorFlag == false &&
    clientEmailErrorFlag2 == false && clientEmailErrorFlag3 == false && clientPhone1ErrorFlag == false && 
    clientPhone2ErrorFlag == false && clientCategoryErrorFlag == false && clientDesignationErrorFlag == false && clientCityErrorFlag == false && 
    ...
    clientAddressErrorFlag == false)
    {
        ...
        client.clientPhone1 = $("#clientPhone1").val();
        client.clientPhone2 = $("#clientPhone2").val();
...
function resetInputField(){
    ...
    $("#clientPhone1Error").text("");
    $("#clientPhone2").text("");
    $("#clientPhone2").val("");
    $("#clientPhone2").css({"border-color":"#ccc"});
    $("#clientPhone2Error").text("");
    $("#clientCategory").text("");
    $("#clientCategory").val("");
